...
const newContent =
  "\nexport type IdentifierMetadata = import('@automock/adapters.inversify').IdentifierMetadata;\n";
...
fs.readFile(filePath, 'utf8', function (err, data) {
  ...
  fs.writeFile(filePath, updatedData, 'utf8', function (err) {
    ...
    console.log(
      'Automock: @automock/common typings file updated successfully with the proper Automock adapter'
    );
  });
});
