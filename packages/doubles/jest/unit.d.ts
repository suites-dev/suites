/**
 * @fileoverview Type augmentation for Jest testing framework integration with Suites.
 *
 ...
 * `@suites/core.unit` with Jest-specific implementations.
 *
 * **Architecture Pattern:**
 * - **Abstraction Layer** (`@suites/unit`): Defines base types like `Mocked<T>`, `Stub`, `UnitReference`
 * - **Augmentation Layer** (this file): Overrides those types with Jest-specific implementations
