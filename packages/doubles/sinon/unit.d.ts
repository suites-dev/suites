...
declare module '@suites/unit' {
   ...
   */
  export type Stub<TReturn> = SinonStub<TReturn>;

  /**
   * Represents a mocked instance of a given type.
   *
   * @since 3.0.0
   * @alias SinonMocked - An instance of a stubbed object type with
   * functions replaced by stubs.
  ...
  export interface UnitReference {
     ...
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided string-based token.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided string-based token and identifier metadata.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided symbol-based token.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @param identifierMetadata An accompanying metadata object for the token identifier.
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided symbol-based token and identifier metadata.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided type identifier.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @param identifierMetadata An accompanying metadata object for the token identifier.
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided type identifier and identifier metadata.
     * @see https://suites.dev/docs/api-reference
     * @example
     ...
     * @param identifierMetadata An accompanying metadata object for the token identifier.
     * @throws {IdentifierNotFoundError} If the dependency is not found.
     * @returns {SinonMocked<TDependency>} The mocked object corresponding to the provided identifier, along with any available identifier metadata.
     * @see https://suites.dev/docs/api-reference
     * @example
     * const mockedService = unitRef.get<MyService>(MyService, metadata);
     * // or
