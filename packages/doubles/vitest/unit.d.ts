/**
 * @fileoverview Type augmentation for Vitest testing framework integration with Suites.
 *
 ...
 * `@suites/core.unit` with Vitest-specific implementations.
 *
 * **Architecture Pattern:**
 * - **Abstraction Layer** (`@suites/unit`): Defines base types like `Mocked<T>`, `Stub`, `UnitReference`
 * - **Augmentation Layer** (this file): Overrides those types with Vitest-specific implementations
