...
declare module '@suites/core' {
   ...
   * In this context, the `StubbedInstance` type is replaced by `Mocked`.
   *
  ...
  export interface UnitReference {
     ...
     * @returns Mocked<TDependency> The mocked object corresponding to the provided
     ...
     * string-based token.
     */
    get<TDependency>(token: string): Mocked<TDependency>;
     ...
     */
    get<TDependency>(token: string, identifierMetadata: IdentifierMetadata): Mocked<TDependency>;
     ...
     * symbol-based token.
     */
    get<TDependency>(token: symbol): Mocked<TDependency>;
     ...
     */
    get<TDependency>(token: symbol, identifierMetadata: IdentifierMetadata): Mocked<TDependency>;
